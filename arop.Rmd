...
cor.test(aropes3_other$pct_eu_arope, aropes3_other$low_life_satisfaction)

eu_r2_label <- tibble(
  x = min(aropes3_other$pct_eu_arope), 
  y = max(aropes3_other$low_life_satisfaction), 
  label = "r<sup>2</sup>=0.56"
)
...
ggplot(aropes3_other, aes(x = pct_eu_arope, y = low_life_satisfaction)) + 
  ...
  scale_y_continuous(labels = scales::label_percent(suffix = " %")) + 
  scale_x_continuous(labels = scales::label_percent(suffix = " %")) + 
  labs(x = "% domácností pod 50 % evropského mediánu nebo v materiální či sociální deprivaci", 
...
cor.test(all_other_indicators$under_arop, all_other_indicators$low_life_satisfaction)
eu_r2_label <- tibble(
  x = min(all_other_indicators$under_arop), 
  y = max(all_other_indicators$low_life_satisfaction), 
  label = "r<sup>2</sup>=0.54"
)
