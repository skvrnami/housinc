...
modelsummary(
    ...
    fmt = 2,
    title = "Models explaining housing precarity and its facets",
    output = "paper/figs/models_precarity.html"
) 
...
modelsummary(
    ...
    fmt = 2,
    title = "Czechia",
    output = "paper/figs/models_precarity_cz.html"
) 
...
modelsummary(
    ...
    fmt = 2,
    title = "Belgium",
    output = "paper/figs/models_precarity_be.html"
) 
...
modelsummary(
    ...
    fmt = 2,
    title = "Germany",
    output = "paper/figs/models_precarity_de.html"
)
...
modelsummary(
    ...
    fmt = 2,
    title = "Estonia",
    output = "paper/figs/models_precarity_ee.html"
) 
...
modelsummary(
    ...
    fmt = 2,
    title = "Finland",
    output = "paper/figs/models_precarity_fi.html"
) 
...
modelsummary(
    ...
    fmt = 2,
    title = "Italy",
    output = "paper/figs/models_precarity_it.html"
) 
...
modelsummary(
    ...
    fmt = 2,
    title = "Netherlands",
    output = "paper/figs/models_precarity_nl.html"
)
...
modelsummary(
    ...
    fmt = 2,
    title = "Romania",
    output = "paper/figs/models_precarity_ro.html"
) 
...
```{r}
plot_comparison_m02 <- function(term){
    bind_rows(
        ggeffect(cz_m02, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Czechia"),
        ggeffect(be_m02, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Belgium"),
        ggeffect(de_m02, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Germany"),
        ggeffect(ee_m02, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Estonia"),
        ggeffect(fi_m02, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Finland"),
        ggeffect(it_m02, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Italy"),
        ggeffect(nl_m02, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Netherlands"),
        ggeffect(ro_m02, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Romania")
    ) -> tmp

    tmp |> 
        ggplot(aes(x = x, y = predicted, colour = country)) + 
        geom_point(
        ...
        labs(colour = "Country", y = "predicted probability", x = "") + 
        coord_flip() + 
        theme_minimal() + 
...
plot_comparison_m02("hh_age") + 
    ggtitle("Predicted probability of housing precarity by age group")

ggsave("paper/figs/plot_housing_precarity_age.png", width = 8, height = 6)

plot_comparison_m02("tenure_status") + 
    ggtitle("Predicted probability of housing precarity by tenure")

ggsave("paper/figs/plot_housing_precarity_tenure.png", width = 8, height = 6)

plot_comparison_m02("hh_type") + 
    ggtitle("Predicted probability of housing precarity by household type")

ggsave("paper/figs/plot_housing_precarity_hh_type.png", width = 8, height = 6)

plot_comparison_m02("income_disposable_eqi_quantile") + 
    ggtitle("Predicted probability of housing precarity by income quantile")

ggsave("paper/figs/plot_housing_precarity_income.png", width = 8, height = 6)

plot_comparison_m02("r_dwelling_type") + 
    ggtitle("Predicted probability of housing precarity by dwelling type")

ggsave("paper/figs/plot_housing_precarity_dwelling.png", width = 8, height = 6)

plot_comparison_m02("r_econ_status") + 
    ggtitle("Predicted probability of housing precarity by economic status")

ggsave("paper/figs/plot_housing_precarity_econ.png", width = 8, height = 6)

plot_comparison_m02("r_renovated") + 
    ggtitle("Predicted probability of housing precarity by renovation")

ggsave("paper/figs/plot_housing_precarity_renovation.png", width = 8, height = 6)

plot_comparison_m2 <- function(term){
    bind_rows(
        ggeffect(cz_m2, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Czechia"),
        ggeffect(be_m2, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Belgium"),
        ggeffect(de_m2, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Germany"),
        ggeffect(ee_m2, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Estonia"),
        ggeffect(fi_m2, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Finland"),
        ggeffect(it_m2, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Italy"),
        ggeffect(nl_m2, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Netherlands"),
        ggeffect(ro_m2, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Romania")
    ) -> tmp
...
plot_comparison_m2("hh_age") + 
    ggtitle("Predicted probability of housing unaffordability by age group")

plot_comparison_m2("tenure_status") + 
    ggtitle("Predicted probability of housing unaffordability by age group")

plot_comparison_m2("hh_type") + 
    ggtitle("Predicted probability of housing unaffordability by household type")

plot_comparison_m2("income_disposable_eqi_quantile") + 
    ggtitle("Predicted probability of housing unaffordability by income quantile")

plot_comparison_m2("r_dwelling_type") + 
    ggtitle("Predicted probability of housing unaffordability by dwelling type")

plot_comparison_m2("r_econ_status") + 
    ggtitle("Predicted probability of housing unaffordability by economic status")

plot_comparison_m2("r_renovated") + 
    ggtitle("Predicted probability of housing unaffordability by renovation")

plot_comparison_m4 <- function(term){
    bind_rows(
        ggeffect(cz_m4, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Czechia"),
        ggeffect(be_m4, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Belgium"),
        ggeffect(de_m4, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Germany"),
        ggeffect(ee_m4, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Estonia"),
        ggeffect(fi_m4, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Finland"),
        ggeffect(it_m4, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Italy"),
        ggeffect(nl_m4, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Netherlands"),
        ggeffect(ro_m4, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Romania")
    ) -> tmp
...
plot_comparison_m4("hh_age") + 
    ggtitle("Predicted probability of housing insecurity by age group")

plot_comparison_m4("tenure_status") + 
    ggtitle("Predicted probability of housing insecurity by age group")

plot_comparison_m4("hh_type") + 
    ggtitle("Predicted probability of housing insecurity by household type")

plot_comparison_m4("income_disposable_eqi_quantile") + 
    ggtitle("Predicted probability of housing insecurity by income quantile")

plot_comparison_m4("r_dwelling_type") + 
    ggtitle("Predicted probability of housing insecurity by dwelling type")

plot_comparison_m4("r_econ_status") + 
    ggtitle("Predicted probability of housing insecurity by economic status")


plot_comparison_m6 <- function(term){
    bind_rows(
        ggeffect(cz_m6, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Czechia"),
        ggeffect(be_m6, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Belgium"),
        ggeffect(de_m6, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Germany"),
        ggeffect(ee_m6, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Estonia"),
        ggeffect(fi_m6, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Finland"),
        ggeffect(it_m6, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Italy"),
        ggeffect(nl_m6, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Netherlands"),
        ggeffect(ro_m6, terms = term) |> 
            as.data.frame() |> 
            mutate(country = "Romania")
    ) -> tmp
...
plot_comparison_m6("hh_age") + 
    ggtitle("Predicted probability of poor housing quality by age group")

plot_comparison_m6("tenure_status") + 
    ggtitle("Predicted probability of poor housing quality by age group")

plot_comparison_m6("hh_type") + 
    ggtitle("Predicted probability of poor housing quality by household type")

plot_comparison_m6("income_disposable_eqi_quantile") + 
    ggtitle("Predicted probability of poor housing quality by income quantile")

plot_comparison_m6("r_dwelling_type") + 
    ggtitle("Predicted probability of poor housing quality by dwelling type")

plot_comparison_m6("r_econ_status") + 
    ggtitle("Predicted probability of poor housing quality by economic status")

plot_comparison_m6("r_renovated") + 
    ggtitle("Predicted probability of poor housing quality by renovation")
